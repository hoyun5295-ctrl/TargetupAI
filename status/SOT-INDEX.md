...
| **대행발송 셀프 접수**(직원 수작업 → 기계 · 승인만 담당자) — 호출어 **대행발송** | [2026-08-22-agency-send-design.md](../docs/2026-08-22-agency-send-design.md) | **§0 30초 요약 → §3 불변 9(큐 적재는 당일 재검사 통과 뒤 1회뿐) → §4 구조.** 확정 대기 = §8 · 착수 순서 = §9 |
