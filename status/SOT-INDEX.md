...
| **AI 자동제작** — 재료(행사 카드·상품·이미지·기능 칩) → 버튼 1 → DM·이메일 완성본(원클릭 캠페인 승격 · 신규 엔진·키·DDL 0 · 0914 배포완료) | **AI 자동제작** | [FEATURE-AI-AUTO-BUILD.md](../docs/FEATURE-AI-AUTO-BUILD.md) | **§2 불변 원칙 15개(필독 — 돈 단위 = attemptToken + 과금 지문 · 판독비는 초안 뒤 정산 · 가격·링크 AI 미경유 · 몰 재조회는 상품번호 · 칩은 엔진이 만드는 것만 · 신규 ENV 비면 미노출) → §3 구조 → §4 요금·ENV → §5 실측 5건(미실행).** 이력·뒤집힌 판단 = §6 · 남은 것 = §7. 시점 근거 = [0914 설계서](../docs/2026-09-14-ai-auto-build-design.md)(§13 구현 기록 · §14 배포 원장) |
