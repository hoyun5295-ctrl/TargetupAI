...
- [ ] **우커머스 연동(일본이모 4몰 · 박성용 경유)**: [설계서](../docs/2026-09-14-woocommerce-integration-design.md) **W1~W7 코드완료(0914 · tsc 0 · 4,633 · DDL 0) · 배포 대기** → W8 실측 게이트 ②③(고객사 REST 키·웹훅 생성 의존). 회신 잔여 = 수신동의 메타키·규모·담당자
