...
### AI 영업 아웃리치 — ★0905 샘플 학습 층·재료 실측·검수 발송·운영 조작 + **실물 예시 DB 학습(B안)** 코드완료 · **배포 대기(선행 = `fail_detail` ALTER)** · [B-0905-1](BUGS.md) 동반
...
> 잔여 = ALTER → 배포 → OPS ⑦ 실측 7단계(7 = 화면에서 29건 코드 적재 · 이메일 4건) → Codex 리뷰(설계서 §15). `scratch/proto` = 폐기 대상
