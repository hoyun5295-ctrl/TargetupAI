...
> ㉒ **전송자격인증제 — 계약종료 계정차단 3단 코드완료·나머지 착수 전** — 호출어 **"전송자격인증"** → [전송자격인증](../docs/2026-08-18-transmission-qualification-cert.md)가 전부 소유(대조표 §3 · 완료분 §4-A · MFA 설계 §4-B · 심사 위험 §6 · 확인 3건 §7)
