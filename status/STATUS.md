...
> 잔여 = **배포 전 확인 1건**(§9-A 남은 것 — 혜택 입력이 보완) · 이어달리기 실측 1건(§9-6) · 스튜디오 실측 6건([여정 문서 §6-1 08-08(2)~(7)](docs/FEATURE-JOURNEY.md)) · 화면 실측 8종 · 자동 종료 기본화 · 별건 5(§9-A 2 + 기존 3 — 편집기 혜택 차단은 0808(2) Codex 2R로 닫힘)
