...
> ★ **SNS 게시 — 0920 S0 종료 · S1 착수 대기(코드 0 · DDL 0)** — 호출어 **"SNS 게시"** → [설계서](../docs/2026-09-17-sns-publish-design.md)가 전부 소유(**확정 상수 §1-4** · 단계 §5 · 별건 §9). 다음 한 수 = S1 · 게이트 = 자사 계정 `active` 1건 화면
