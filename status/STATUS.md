...
> ★ **직접발송 보내기 전 점검 · 대행 맞춤법 · 스팸 무료 체험 — ★0925 코드 완료 · Codex 7라운드 종료(high 0) · DDL 2 실행 완료 · 맞춤법 AI 한도 면제 B안 반영 · 미배포** — [설계서](../docs/2026-09-25-direct-send-precheck-design.md)가 전부 소유(DDL·확인 SQL §4 · 영향표 §5). 다음 = 배포 → 실측
> ★ **알림톡 · 브랜드메시지 발송 창 전면 개편 — ★0925 코드 완료 · Codex 13라운드 종료(13R approve) · DDL 0 · 미배포** — 호출어 **"카카오 발송 창"** → [설계서](../docs/2026-09-25-kakao-send-windows-redesign.md)가 전부 소유(불변 1~12 · 영향표 · 추가 과제). 다음 = 배포 → 실측(알림톡 1 · 브랜드 자유형 1 · 브랜드 등록 템플릿 1 · 채널 전환 명단 · 주소록 불러오기 취소)
