...
> ★ **직접발송 보내기 전 점검 · 대행 맞춤법 · 스팸 무료 체험 — ★0925 배포완료 · DDL 2 실행 완료** — [설계서](../docs/2026-09-25-direct-send-precheck-design.md)가 전부 소유(DDL·확인 SQL §4 · 영향표 §5 · 이력). 다음 = 실측
> ★ **알림톡·브랜드 발송 창 개편 + 직접입력 창 통일 — ★0925 배포완료 · DDL 0** — 호출어 **"카카오 발송 창"** → [설계서](../docs/2026-09-25-kakao-send-windows-redesign.md)가 전부 소유(불변 · 영향표 · 이력 · 실측 · 추가 과제). 다음 = 실측
