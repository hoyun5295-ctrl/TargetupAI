...
> ★ **SNS 게시 — 0920 S1 배포·게이트 통과(자사 계정 `active` 화면 확인)** — 호출어 **"SNS 게시"** → [설계서](../docs/2026-09-17-sns-publish-design.md)가 전부 소유(**확정 상수 §1-4** · 단계 §5 · 별건 §9). 다음 한 수 = Codex 적대 검토 → S2(미디어·캡션)
