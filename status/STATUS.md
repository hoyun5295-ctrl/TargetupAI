...
> ⑮ **브랜드메시지 — 규격 정합·preflight 배포완료 / 정석(BM_FREE_REQ) 유지·휴머스온 회신 대기** — 호출어 **"브랜드메시지"** → [FEATURE-GW-BRAND-MESSAGE.md](../docs/bito-gateway/FEATURE-GW-BRAND-MESSAGE.md)가 전부 소유(`4101`=시리얼 Prefix 날짜 §3 · `.54`는 BM 경로 미사용 확정 §3 · REST `4005` 불변 §3-1 · 문의문 §6-2). 정산 회계분 = [정산 §7](../docs/FEATURE-BILLING.md)
...
> ㉑ **접속 인계 — 이미 접속 중인 아이디 안내·선택 신설** — 호출어 **"접속 인계"** → [접속 인계](../docs/2026-08-18-session-takeover.md)가 전부 소유. DDL 0 · 계약 10건 · 잔여 = §5(실측 1건 + SCHEMA.md `app_source` 보강)
