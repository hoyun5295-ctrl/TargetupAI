...
### 대행발송 셀프 접수 · 0825 전량 배포완료 + 0825(4) 문안 항목 AI 매핑 §17-6 코드완료·배포 대기 · 남은 것 = 운영 실측
> 호출어 **"대행발송"** → **[2026-08-22-agency-send-design.md](../docs/2026-08-22-agency-send-design.md)가 전부 소유**(30초 요약 §0 → 불변 §3 → 구조 §4 → 소유권 §12-F → 계약 §12-G · 당일 재검사 폐지 §14 · **화면 개편 §15 · 링크 승인 §16 · 요청서 원스텝 §17 · 문안 항목 AI 매핑 §17-6**)
