...
> ⑯ **게이트웨이 PAY 통계 적재 — ★0815 구현 완료(미배포)** — [허브 §10](../docs/FEATURE-BITO-GATEWAY.md)이 소유. `.54` 업체 이관의 전제. SysId `65` · 커밋 `77be7ff` · **배포 순서 = 마이그레이션 050 선적용 → 바이너리**. 다음 = 실측(규격서 §10 — 5건 추가 후 행이 1개인지)
