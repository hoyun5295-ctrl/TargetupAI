...
> ⑮ **브랜드메시지 — 0815 4101 원인 확정(계정 권한) + ★0818 매뉴얼 v2.3.1 규격 정합 8건 정정(코드 완료·배포 대기)** — 호출어 **"브랜드메시지"** → [FEATURE-GW-BRAND-MESSAGE.md](../docs/bito-gateway/FEATURE-GW-BRAND-MESSAGE.md)가 소유(4101 = §3 · 규격 정합·재문의 5항 = §4-2). 다음 = 배포 후 휴머스온 회신 대기
