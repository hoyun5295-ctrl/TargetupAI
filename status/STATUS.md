...
> 상태 = 전량 배포완료(0726 `b396e2a5` · 0728~0731 · 0804 2차 · 0805 재오픈 2건·총 정산표·확정 축) · **팝빌 운영 전환 완료**(`★운영★`). **0805(2) 서수란 접수 5건 배포완료 + DDL 실행완료**(`47cae365` · 문서 §8-3 · Codex 4R). **후속 3건 코드 완료·배포 대기** = 삭제 가드 확대(B-0805-2) · 잠금 CT 통합(B-0805-1) · 발급 대기 취소 신설.
> 잔여 = **1순위 = `failed` 2건 수동 재시도**(문서 §5) · 실측(0805(2) 6건 · 재오픈 2건 · 총 정산표 · 실회사 드라이런 · 거래내역서 MMS) · 발급 대기 취소 창구 부재 · 특수정산 엑셀 업로드 = 문서 §7.
