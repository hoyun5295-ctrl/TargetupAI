...
> 잔여 = **Phase 0~4 전량 구현완료(0810·배포 대기)** — 조각별 내역은 [설계서 §7](../docs/2026-08-09-cdp-integration-redesign-design.md). 롤백 = `CDP_DASHBOARD_V2=false`. 다음 = **배포·실측** → Phase 5. 착수 전 확인 §9 중 4·6·7·8 미해결
