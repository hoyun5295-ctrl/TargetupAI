...
> **★0718 성능·사고 후속(활성)**: B-0718-1 종결 조건 ①서버 git 일치(d6958238) ②재발 방지 게이트(safe-build 3-1 lazy 청크 실존/3-2 비literal 동적 import 검출 + verify-live-chunks.sh 라이브 전수) 완료 — Codex 5라운드 통과·하네스 실측. 로컬 "온전" 빌드도 19/38지점 암호화 불량 실측 정정. **잔여 = ③난독화 exclude 실측→④M1 재시도(Harold 승인) · ⑦ 워밍 백엔드분 이새 SLOW 실측 · 화~수 관측 상위 20 사이클 · M2/M3/롤업.** SoT=docs/2026-07-18-frontend-splitting-incident-handoff.md · 상세=[[project_2026_0717_dashboard_performance]] · 0717 성능 1~7차 원문=archive/TASKS_2026-07.md.
