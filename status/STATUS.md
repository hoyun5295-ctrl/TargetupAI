...
> ㉓ **정산 — 0821 3건 코드완료·배포 대기**(080 고정료·작성일자 / 계산서 비고 PO / 선택 발송 묶음 정정 [B-0821-3](BUGS.md)) — 호출어 **"정산"** → [정산 §2-18~20·§8](../docs/FEATURE-BILLING.md)이 전부 소유. 다음 = 배포 → 실측. [고객 입력 자동화](../docs/2026-08-21-taxbill-remark-customer-confirm-design.md)는 **홀딩**(§9)
