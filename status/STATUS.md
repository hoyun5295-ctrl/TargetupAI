...
### 대행발송 셀프 접수 — 입구 3 전량 배포완료 · **★0910 직원 접수 4건 코드완료·배포 대기(DDL 1 · 불변 23 개정)** · ★0905 메일 1통 = 요청서 N건 + `발송 ID` 칸 코드완료·배포 대기(§21 · DDL 0)
...
> **★0910 = [B-0910-6~10](BUGS.md) · DDL `mms_image_names` 배포 뒤 실행** · 잔여 = **운영 실측만**(§20-5 · §15~§18-12 이월 · 0828 육안) · 수용 위험 §16-3~§20-6 · 별도 과제 §14-6·§18-4·[B-0825-6](BUGS.md)·[B-0825-7](BUGS.md)
