...
> SoT [여정 재설계](docs/2026-08-01-journey-redesign-design.md) **§11-C(원장 직독·§11-C-6-B F1) → §11-A·§11-B → §11(순서)** · 기억 [[project_2026_0801_journey_redesign]] · 호출어 **여정 재설계 이어가자** · 다음 = **실측 5건(§11-C-6)** → §11-5(트리거 15종 재정의)
