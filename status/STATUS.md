...
### ⏱ 세션 포인트 체크 — 2026-09-16 (모바일 DM 블록 조립 · **정산 접수 2건** · **단축 URL 한글 주소**)
...
> ★ **몰별 사용자 연동 — 0918 설계·승인·구현 완료(P1~P4) · 배포 대기** — 호출어 **"몰별 사용자 연동"** → [설계서](../docs/2026-09-18-mall-integration-user-scope-design.md) §9 · 다음 = 배포(서버 먼저) → 실측 §6 → 이에스페이먼트 안내 → P5(5 provider)
> ★ **SNS 게시 — 0917 브레인스토밍 수렴 · 설계서 완료 · Harold 검토 대기(코드 0 · DDL 0)** — 호출어 **"SNS 게시"** → [설계서](../docs/2026-09-17-sns-publish-design.md)가 전부 소유(불변 §2 · 구조 §3 · 화면 §4 · 단계 §5 · 회의록 §8). 다음 한 수 = Harold 검토·결재 4건(§7 ④ 표시 의무 · NEW 배지 · X 계정 · 크레딧 값은 2차) → S0(Meta 앱 · raw curl 1건)
