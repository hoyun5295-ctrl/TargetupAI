...
> 잔여 = **Phase 0·1·2 구현완료(0810·배포 대기)** — bySource + 정규화 CT + 판정 훅 + 현황판 컴포넌트 + 계약 테스트 11건(결함 주입 검출 확인). 롤백 = `CDP_DASHBOARD_V2=false`. 다음 = Phase 3 진행 패널(검증 탭 흡수). 착수 전 확인 §9 중 2·4·6·7·8 미해결
