...
> ⑩ **원스텝 AI 컨텐츠 생성 — 기능 최우선** · 호출어 **"원스텝 생성"** → **[설계서](../docs/2026-08-13-one-step-content-interview-design.md)가 전부 소유**. Phase 0~4 배포·DDL 완료 · **0814 정정 = §9~§9-3(자체 5건 + Codex 13R `approve` 종결 · 수용 20)** · 미배포·DDL 0 · 다음 = 실측 1건(§7).
