...
| 날짜 | 제목 | 검색 키워드 | 파일 |
|------|------|-------------|------|
| 2026-09-22 | 🟢 세션 포인트 카드 원문(0925 회전) — 브랜드메시지 직원 접수 3건 + 버튼 종류 정합 + 링크 검사 전 채널 | 캐러셀 커머스 상품 정보가 필요 합니다 이미지형 줄바꿈 99 버튼 종류 정합 링크 검사 FormControls.TextInput 비즈니스폼 bizFormId k_etc_json scheme 9999 seqno 115661 B-0922-3 B-0922-4 B-0922-5 B-0922-6 bdc857ee 5a462669 11638828 | [TASKS_2026-09.md](TASKS_2026-09.md) |
| 2026-09-16 | 🟢 세션 포인트 카드 원문(0918 회전) — 모바일 DM 블록 조립 · 정산 접수 2건(계정별 장 테스트·스팸 합류 · 수기 부가서비스 수량 컬럼) · 단축 URL 한글 주소 · 이메일 캠페인 8건(편집기 속성 6종 발송 HTML 미반영) | 블록 조립 쪽 템플릿 넘김 효과 settings.effect 목록 리스트형 시작 화면 입구 B-0916-1 B-0916-2 B-0916-3 계정별 장 테스트 스팸 quantity item_qty item_label 572e133a 단축 URL 한글 주소 20크레딧 5b6ef1cd B-0916-4 B-0916-5 B-0916-6 이메일 헤더 형태 히어로 오버레이 매장 지도 SNS 표시 방식 아웃룩 td bgcolor primarySoftOpaque 푸터 수신거부 hiddenFields B-0916-7 B-0916-8 d8e8c7d9 | [TASKS_2026-09.md](TASKS_2026-09.md) |
...
| 2026-07-04 | 🟢 문안 퀄리티 엔진(cold-start) + 비토 자체게이트웨이 라인13 E2E 완주 + 메모리 관제탑 정리 (STATUS→archive 회전 2026-07-20) | 문안 퀄리티 엔진 cold-start GPT 차별화 best-copy 비토 자체게이트웨이 라인13 E2E SMSQ_SEND_13 메모리 관제탑 정리 fix분 재배포 | [TASKS_2026-07.md](TASKS_2026-07.md) |
...
| 2026-07-05 | 🟢 2026-07-05 (3·4) — 마케팅 캘린더 헛점 12건 근본수정(yearly 스케줄·모달 N×200·차감구조·서버저장·P2-6 컨텍스트·한달 재설계 10) + 카페24 심사 반려 3건 대응(설치 OAuth 로그인 분리·자동시작·상세이미지) (★배포완료·DDL 2건) | 자동마케팅 캘린더 크레딧 오퍼레이터 카페24 OAuth 설치 심사 발송 schedule_month company_marketing_calendars marketing-calendar-store cafe24-install-state | [TASKS_2026-07.md](TASKS_2026-07.md) |
| 2026-07-05 | 🟢 2026-07-05 (2) — 여정 재점검: 3버그(네비 이탈·광고 이중부착 dedup·매장번호 미등록 자동실패) + 발송 피로도 보호(opt-in 전역 게이트 5경로) + 계절감 제거 (★전부 배포완료) | 여정 광고 080 피로도 계절 발송 매장번호 fatigue-guard journey-ai-generator messageUtils | [TASKS_2026-07.md](TASKS_2026-07.md) |
