...
*최종 업데이트: 2026-03-04 11차 버그리포트 5건 수정 완료 (B11-01~05). 하드코딩 전수조사 기반 CRITICAL 항목 전체 해소 + 설정값 중앙집중화 완료. config/defaults.ts 공통 모듈로 AI 모델·Redis·타임아웃·배치·캐시·Rate Limit·토큰한도 통합 관리.*
