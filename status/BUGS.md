...
*최종 업데이트: 2026-03-06 12차 버그리포트 4건 수정 (B12-01~04) + 기능개선 3건 (F12-01~03) 완료. 예약취소 Agent 대응, 발송결과 타임아웃, 스팸필터 제목전달, 모달 공용화, AI 머지태그 표시, 필터 UI 개선(성별 자동감지+금액 범위입력), 담당자테스트 버튼 추가. 수신자 목록 테이블 성별 한글 표시 적용.*
