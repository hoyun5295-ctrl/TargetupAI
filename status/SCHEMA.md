...
- `studio_image`: `{ url, usedCutout, personJudge, skippedReason, width, height, templateId, category, kind, media(stats)|null, mediaError|null, regenCount }` · ★2026-09-06 S3 `+ posterTexts{label,title,subtitle,dropped[]}, cutoutSource('alpha_png'|'rembg'|null), posterScore{outcome,digits,headlineVisible}|null, posterRegenerated, bannerUrl|null, bannerSize|null` · ★2026-09-09(6) `+ cutoutFrom(누끼를 딴 원천 URL · 선택 이미지 또는 상품 사본 · 누끼 0 = null)`
