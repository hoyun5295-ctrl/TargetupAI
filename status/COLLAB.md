...
**목표 = 모두가 납득하는 베스트 기획안 1개를 도출한다**(★2026-08-22 Harold 명시 개정).

> **이 회의는 싸우는 자리가 아니다.** 각 역할은 자기 관점에서 **의견을 적극적으로 낸다** — 눈치 보고 접는 것도 회의를 망친다.
> 다만 그 의견은 **더 좋은 방향을 찾기 위한 건전한 토론**이지 상대를 꺾기 위한 것이 아니다.
> 다른 역할의 안에 문제가 보이면 **문제만 지적하고 끝내지 말고 어떻게 하면 그 안이 살아나는지를 함께 낸다.**
> 산출물은 승패가 아니라 **다섯 역할이 전부 "이거면 됩니다"라고 말할 수 있는 안 하나**다.
> 의견 나열로 끝나면 실패이고, 한 역할이 침묵으로 양보해서 만든 합의도 실패다.
...
- **회의론자는 모든 회의에 고정**이다. 단 ★2026-08-22 개정 — 이 역할은 **부수는 자리가 아니라 안을 튼튼하게 만드는 자리**다.
  "이대로 하면 어디서 깨지는가"를 묻되, 깨지는 지점을 찾으면 **그 지점을 막은 형태까지 제안한다.** 반대만 하고 대안이 없으면 그 의견은 채택되지 않는다.
...
1. **제안** — 무엇을 어떻게 할 것인가. 자기 관점에서 **적극적으로** 낸다(다른 역할이 싫어할까 봐 접지 않는다)
2. **위험** — 이 방식이 깨지는 지점. **자기 안의 약점도 포함한다**(남의 안만 흔드는 자리가 아니다)
3. **우리 코드 근거** — 파일·행 번호. 근거 없으면 그 의견은 폐기 대상
4. **토론** — 2라운드에서 채운다. ★2026-08-22 개정으로 "반박"에서 이름과 성격을 함께 바꿨다:
   - 다른 역할 의견 중 **동의하는 것을 먼저 적는다**(무엇을 받아들였는지가 수렴의 절반이다)
   - 동의하지 않는 지점은 근거를 대되 **"그 안을 이렇게 고치면 살아난다"까지 함께 낸다.** 문제 지적만 하고 끝내지 않는다
   - 자기 1차 안 중 **접을 것은 접는다.** 접은 이유를 적는다(끝까지 자기 안을 지키는 것이 목적이 아니다)
...
3. **1차 의견 수집**
4. **교차 토론 1라운드** — 수집한 의견을 각 역할에 전부 되돌려 §1-5의 4번(동의·보완·자기 안 접기)을 받는다. 1라운드로 끝낸다.
5. **회의론자 최종 검증** — 수렴안을 회의론자에게 보내 "이대로 하면 어디서 깨지는가"와 **그 지점을 막은 형태**를 함께 받는다.
6. **주재자 수렴** — 하나로 좁혀 Harold님께 제시한다. **다섯 역할이 전부 납득했는지**가 수렴의 기준이고,
   끝까지 갈린 지점이 있으면 숨기지 말고 "여기는 갈렸고 이 근거로 이쪽을 택했다"를 함께 보고한다.
