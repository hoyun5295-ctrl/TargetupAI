...
- **강조표기형(TEXT) 입력 필드 정정** — 보조문구 필수화 + 두 필드 표시 자수 안내. **코드 완료·배포 대기**(0805, `frontend tsc 0`). 규격 4값 전부 확정 · 남은 것은 화면 실측 3건 = [2026-08-05 설계서](2026-08-05-alimtalk-emphasize-text-design.md) §5
