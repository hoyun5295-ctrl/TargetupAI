...
> ★2026-09-24 이 절의 "저장만"과 §9-1 글자 긁기(판 1)는 **[B 네이버 스토어 판독기 설계서](2026-09-24-outreach-naver-store-reader-design.md)가 대체**한다(북마크 판 2 = 스토어 상태 허용 칸 · 기획·상품 판독 · 확인 화면 후보). 아래는 경위 기록이다.
