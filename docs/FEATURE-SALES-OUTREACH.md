...
| [같은 문서 §16 (2026-08-26 v3)](2026-07-31-ai-sales-outreach-design.md) | **스마트스토어 재료 축(승인 · 다음 세션 구현)** — 실측 전제 §16-1 · ⛔ 원칙 10 §16-2 · 흐름 §16-3 · DDL 1 §16-4 · 백엔드 계약(H1~H15 반영) §16-5 · 화면 §16-6 · 엑셀 §16-7 · 계약 테스트 9 §16-8 · **착수 전 실측 게이트 G1~G5 §16-9** · 순서 §16-10 · Harold 결재(약관) §16-11 · 뒤집힌 판단 9 §16-12 |
