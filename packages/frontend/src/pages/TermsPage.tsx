        ...
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="prose prose-sm text-gray-700 space-y-6">
            ...
            <section>
              ...
              <p>1. "서비스"란 회사가 제공하는 AI 기반 SMS/LMS/MMS/카카오톡 마케팅 자동화 플랫폼을 말합니다.</p>
            ...
            <section>
              ...
              <p className="mt-2">1. AI 기반 마케팅 타겟 추출 서비스</p>
              <p>2. 마케팅 메시지 자동 생성 서비스</p>
            ...
            <section>
              ...
              <p>1. 서비스 이용 요금은 회사가 별도로 정한 요금표에 따릅니다.</p>
              <p>2. 메시지 발송 요금은 실제 발송 성공 건수를 기준으로 정산합니다.</p>
              <p>3. 요금 정산은 월 단위로 이루어지며, 회사는 거래내역서를 발행합니다.</p>
            </section>
