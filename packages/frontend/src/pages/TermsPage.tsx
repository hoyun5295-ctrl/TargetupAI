      ...
      <div className="flex-1 py-12 px-4">
        <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="prose prose-sm text-gray-700 space-y-6">
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-800 mt-6 mb-2">제10조 (서비스의 중단)</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-800 mt-6 mb-2">제11조 (면책 조항)</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-800 mt-6 mb-2">제12조 (환불 정책)</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-800 mt-6 mb-2">제13조 (분쟁 해결)</h2>
              <p>1. 이 약관에 명시되지 않은 사항은 관계 법령 및 상관례에 따릅니다.</p>
              <p>2. 서비스 이용으로 발생한 분쟁에 대해 소송이 제기되는 경우, 서울중앙지방법원을 관할 법원으로 합니다.</p>
            </section>

            <section>
              <h2 className="text-lg font-semibold text-gray-800 mt-6 mb-2">제14조 (데이터의 활용)</h2>
            ...
            <section>
              ...
              <p>2. 2026년 2월 24일 개정된 제8조, 제9조, 제12조는 개정일로부터 시행합니다.</p>
              <p>3. 2026년 7월 3일 신설된 제14조는 서비스 화면 공지 후 7일이 경과한 날부터 시행합니다.</p>
            </section>
