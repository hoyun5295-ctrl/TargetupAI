...
export default function InAppMessagesPage() {
  ...
  const handle503 = (data: any): boolean => {
    if (data?.code === 'DB_MIGRATION_PENDING') {
      ...
      showToast('DB 마이그레이션 대기 중 — 운영자에게 문의해주세요.', { type: 'warning' });
      return true;
    }
    return false;
  };
          ...
          <div className="flex items-center gap-2 flex-wrap mb-4">
            ...
            <div className="ml-auto flex gap-2 flex-wrap">
              <select
                ...
                className="text-xs bg-slate-900 border border-white/10 rounded-lg px-2 py-1.5 text-white"
              >
...
function EditModal({ editing, setEditing, availableVariables, onSave, fileInputRef, onImageUpload }: EditModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50" onClick={() => setEditing(null)}>
      <div className="bg-slate-900 border border-white/10 rounded-2xl shadow-2xl w-full max-w-5xl max-h-[95vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        {/* 헤더 */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr,400px] gap-0">
          ...
          <div className="p-6 space-y-5 border-r border-white/5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 mb-2 bg-slate-950 border border-white/10 rounded-lg text-sm text-white placeholder-white/30 focus:outline-none focus:border-violet-400/50"
                maxLength={100}
              />
              <textarea
                value={editing.body || ''}
                ...
                className="w-full px-3 py-2 bg-slate-950 border border-white/10 rounded-lg text-sm text-white placeholder-white/30 resize-y h-32 focus:outline-none focus:border-violet-400/50"
                maxLength={500}
              />
            </div>
              ...
              <div className="flex gap-2 items-center">
                {editing.image_url ? (
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-slate-950 border border-dashed border-white/20 rounded-lg text-xs text-white/70 hover:bg-white/5 flex items-center gap-2"
                  >
                ...
                {(editing.buttons || []).map((btn, idx) => (
                  <div key={idx} className="grid grid-cols-1 md:grid-cols-[1fr,1fr,80px,40px] gap-2 items-center">
                    <input
                      ...
                      placeholder="버튼 라벨"
                      className="px-2 py-1.5 bg-slate-950 border border-white/10 rounded text-xs text-white placeholder-white/30"
                    />
                    <input
                      type="url"
                    ...
                    <select
                      ...
                      className="px-2 py-1.5 bg-slate-950 border border-white/10 rounded text-xs text-white"
                    >
            ...
            <div>
              ...
              <div className="bg-slate-950 border border-white/10 rounded-lg p-3 space-y-2">
                <div className="grid grid-cols-2 gap-2">
                  <input
                    ...
                    className="px-2 py-1.5 bg-slate-900 border border-white/10 rounded text-xs text-white placeholder-white/30"
                  />
                  <input
                    type="text"
            ...
            <div>
              ...
              <div className="bg-slate-950 border border-white/10 rounded-lg p-3 grid grid-cols-2 md:grid-cols-3 gap-1.5">
                {availableVariables.slice(0, 9).map((v) => (
                  <button
                    ...
                    className="text-[10px] bg-slate-900 hover:bg-violet-500/20 border border-white/10 rounded px-2 py-1 text-left transition-colors"
                    title={v.hint}
                  >
              ...
              <div className="space-y-3 pl-4 border-l-2 border-white/10">
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="9"
                      className="w-full px-2 py-1.5 bg-slate-950 border border-white/10 rounded text-xs text-white placeholder-white/30"
                    />
                  </div>
                  <div>
                      ...
                      return (
                        <button
                          ...
                          className={`flex-1 py-1.5 text-[11px] rounded ${
                            allowed ? 'bg-emerald-500/30 text-emerald-100 border border-emerald-400/40' : 'bg-slate-950 border border-white/10 text-white/40'
                          }`}
                        >
                          {day}
                        </button>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-2 py-1.5 bg-slate-950 border border-white/10 rounded text-xs text-white"
                  >
              ...
              <div className="grid grid-cols-3 gap-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-9 bg-slate-950 border border-white/10 rounded cursor-pointer"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full h-9 px-2 bg-slate-950 border border-white/10 rounded text-xs text-white"
                  >
                    <option value="active">활성</option>
                    <option value="paused">일시 중지</option>
                  </select>
          ...
          {/* 우측 — 실시간 미리보기 (영역 10) */}
          <div className="bg-slate-950/60 p-6 space-y-3 sticky top-[60px] h-fit max-h-[80vh] overflow-y-auto">
...
function DrillDownModal({ loading, stats, explain, onClose }: DrillDownProps) {
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50" onClick={onClose}>
      <div className="bg-slate-900 border border-white/10 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[95vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
        <div className="sticky top-0 bg-slate-900 border-b border-white/10 px-6 py-4 flex items-center justify-between">
            ...
            <>
                  ...
                  {stats.funnel.steps.map((step, idx) => {
                    ...
                    return (
                      <div key={idx}>
                        ...
                        <div className="h-6 bg-slate-950 rounded overflow-hidden">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {stats.device.map((d) => (
                    <div key={d.device} className="bg-slate-950 rounded p-3">
            ...
            <div className="bg-gradient-to-br from-violet-500/10 to-fuchsia-500/10 border border-violet-400/30 rounded-xl p-5">
              ...
              <div className="space-y-2">
                {explain.factors.map((f, idx) => (
                  <div key={idx} className="bg-slate-950/60 rounded p-3">
                    ...
                    <div className="h-1.5 bg-slate-900 rounded overflow-hidden mb-1">
                      <div
