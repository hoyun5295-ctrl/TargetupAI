...
#
# 사용(서버에서): bash /home/administrator/targetup-app/packages/frontend/scripts/verify-live-chunks.sh
#   다른 도메인 검사 시 인자로: bash .../verify-live-chunks.sh https://sys.hanjullo.com
# 읽기 전용(GET만) — 서버 상태 무접촉.
# ============================================================

set -u
BASE_URL="${1:-https://hanjul.ai}"
cd "$(dirname "$0")/.."
