...
router.get('/', async (req, res) => {
    try {
        ...
        const contacts = await (0, test_contact_helper_1.getUserTestContacts)(companyId, userId);
...
router.post('/', async (req, res) => {
    try {
        ...
        const result = await (0, test_contact_helper_1.addTestContact)(companyId, userId, name, phone);
        if (!result.success) {
...
router.delete('/:id', async (req, res) => {
    try {
        ...
        const result = await (0, test_contact_helper_1.deleteTestContact)(id, companyId, userId);
        if (!result.success) {
...
//# sourceMappingURL=test-contacts.js.map