...
exports.isSyncActive = isSyncActive;
exports.blockIfSyncActive = blockIfSyncActive;
const database_1 = require("../config/database");
/**
 * 싱크 사용 중인지 판정.
 * - companies.use_db_sync=true AND sync_agents.status='active' 하나 이상
 */
async function isSyncActive(companyId) {
    if (!companyId)
        return false;
    const result = await (0, database_1.query)(`SELECT 1
     FROM companies c
     WHERE c.id = $1
 ...
 */
async function blockIfSyncActive(req, res, next) {
    try {
...
//# sourceMappingURL=sync-active-check.js.map