...
exports.INVITO_INFO = exports.LIMITS = exports.SEND_HOURS = exports.AI_MAX_TOKENS = exports.RATE_LIMITS = exports.CACHE_TTL = exports.BATCH_SIZES = exports.TIMEOUTS = exports.DEFAULT_COSTS = exports.AI_MODELS = exports.redis = exports.REDIS_URL = void 0;
exports.getCompanyCosts = getCompanyCosts;
const ioredis_1 = __importDefault(require("ioredis"));
// ============================================================
// Redis 공통 인스턴스
// ============================================================
exports.REDIS_URL = process.env.REDIS_URL || 'redis://localhost:6379';
exports.redis = new ioredis_1.default(exports.REDIS_URL);
exports.redis.on('error', (err) => console.error('[Redis] 연결 에러:', err.message));
// ============================================================
 ...
 */
function getCompanyCosts(company) {
    return {
        sms: parseFloat(company?.cost_per_sms) || exports.DEFAULT_COSTS.sms,
        lms: parseFloat(company?.cost_per_lms) || exports.DEFAULT_COSTS.lms,
        mms: parseFloat(company?.cost_per_mms) || exports.DEFAULT_COSTS.mms,
        kakao: parseFloat(company?.cost_per_kakao) || exports.DEFAULT_COSTS.kakao,
    };
}
// ============================================================
// 타임아웃 (밀리초)
