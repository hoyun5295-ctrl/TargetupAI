...
exports.isValidCustomFieldKey = isValidCustomFieldKey;
const VALID_CUSTOM_KEYS = new Set(Array.from({ length: 15 }, (_, i) => `custom_${i + 1}`));
/**
 * custom_fields JSONB 키가 유효한지 검증
 * @param name - 검증할 필드 키 (예: 'custom_1', 'custom_15')
 * @returns true면 안전하게 SQL에 삽입 가능
 */
function isValidCustomFieldKey(name) {
    return VALID_CUSTOM_KEYS.has(name);
}
//# sourceMappingURL=safe-field-name.js.map