...
exports.PLAN_STATUS_SELECT_EXPR = void 0;
exports.loadPlanContext = loadPlanContext;
...
exports.resolveMaxAutoCampaigns = resolveMaxAutoCampaigns;
exports.getDirectRecipientLimit = getDirectRecipientLimit;
exports.checkDirectRecipientLimit = checkDirectRecipientLimit;
 ...
 */
exports.PLAN_STATUS_SELECT_EXPR = `
...
// ═══════════════════════════════════════════════════════════
async function loadPlanContext(companyId) {
    const result = await (0, database_1.query)(`SELECT ${exports.PLAN_STATUS_SELECT_EXPR}
       FROM companies c
    ...
    const isTrialActive = planCode === 'TRIAL' &&
        trialExpiresAt !== null &&
 ...
 */
function isSubscriptionBlocked(ctx) {
 ...
 *     구독 막힘만 없으면 허용.
 */
function canUseFeature(ctx, key) {
...
function resolveMaxAutoCampaigns(ctx) {
 ...
 *   - STARTER 이상: null
 */
function getDirectRecipientLimit(ctx) {
 ...
 */
function checkDirectRecipientLimit(ctx, recipientCount) {
