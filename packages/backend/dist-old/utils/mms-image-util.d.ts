 ...
 */
export type MmsImageItem = string | {
    path?: string;
    originalName?: string;
};
/**
 ...
 */
export declare function getMmsImagePath(item: MmsImageItem): string;
/**
 * mms_image_paths에서 표시용 파일명 추출.
 * - 신규 구조(객체)면 originalName 반환
 * - 과거 구조(문자열)면 경로의 basename 반환 (fallback)
 */
export declare function getMmsImageDisplayName(item: MmsImageItem): string;
/**
 * 배열 전체를 절대경로 string[]로 정규화 (QTmsg용).
 * null/undefined 항목 제거.
 */
export declare function normalizeMmsImagePaths(items: MmsImageItem[] | null | undefined): string[];
//# sourceMappingURL=mms-image-util.d.ts.map