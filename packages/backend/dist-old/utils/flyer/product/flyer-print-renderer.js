...
exports.renderPrintFlyer = renderPrintFlyer;
exports.getAvailableThemes = getAvailableThemes;
exports.getThemeByName = getThemeByName;
exports.getAvailablePaperSizes = getAvailablePaperSizes;
...
// 상품 카드 렌더링
// ============================================================
function renderProductCard(item, t, size) {
...
// ★ 메인 렌더러
// ============================================================
function renderPrintFlyer(data) {
...
/** 용지 사이즈 목록 */
function getAvailablePaperSizes() {
    return Object.entries(PAPER_SIZES).map(([key, val]) => ({ value: key, label: val.label }));
}
//# sourceMappingURL=flyer-print-renderer.js.map