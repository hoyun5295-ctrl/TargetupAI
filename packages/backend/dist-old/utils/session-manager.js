...
exports.invalidateAppSessions = invalidateAppSessions;
exports.createUserSession = createUserSession;
exports.rotateUserSession = rotateUserSession;
exports.newSessionId = newSessionId;
exports.normalizeAppSource = normalizeAppSource;
 ...
 */
async function invalidateAppSessions(userId, appSource) {
    const result = await (0, database_1.query)(`UPDATE user_sessions
     SET is_active = false
     WHERE user_id = $1 AND app_source = $2 AND is_active = true`, [userId, appSource]);
...
async function createUserSession(params) {
    ...
    await (0, database_1.query)(`INSERT INTO user_sessions
 ...
 */
async function rotateUserSession(params) {
 ...
 */
function normalizeAppSource(raw) {
