...
exports.validateScheduledAt = validateScheduledAt;
/**
 * 캠페인 예약 시각을 검증한다.
 *
 * - 파싱 실패: invalid
 ...
 */
function validateScheduledAt(input, options = {}) {
    const { minMinutesFromNow = 0, allowNull = true, maxDaysFromNow = 365, } = options;
