...
exports.REPORT_TYPE_LABEL = exports.IMC_REPORT_CODE_MAP = exports.IMC_RESULT_CODE_MAP = void 0;
exports.resolveImcCode = resolveImcCode;
exports.resolveReportCode = resolveReportCode;
// ════════════════════════════════════════════════════════════
// 관리 API 응답 코드 맵
// ════════════════════════════════════════════════════════════
exports.IMC_RESULT_CODE_MAP = {
    // ── 성공 ─────────────────────────────────────
...
function resolveImcCode(code) {
    return (exports.IMC_RESULT_CODE_MAP[code] || {
        kind: 'system_error',
...
function resolveReportCode(code) {
    return (exports.IMC_REPORT_CODE_MAP[code] || {
        kind: 'unknown',
        userMessage: `알 수 없는 리포트 코드 (${code})`,
    });
}
exports.REPORT_TYPE_LABEL = {
    SM: 'SMS',
    LM: 'LMS',
    MM: 'MMS',
    AT: '알림톡',
...
//# sourceMappingURL=alimtalk-result-map.js.map