...
exports.buildTemplateInspectionNotifyMessage = buildTemplateInspectionNotifyMessage;
exports.sanitizeSmsText = sanitizeSmsText;
exports.buildAiGeneratedNotifyMessage = buildAiGeneratedNotifyMessage;
exports.buildPreNotifyMessage = buildPreNotifyMessage;
exports.buildSpamTestResultNotifyMessage = buildSpamTestResultNotifyMessage;
 ...
 */
function buildTemplateInspectionNotifyMessage(ctx) {
    const lines = [];
 ...
 */
function applyAd(ctx) {
    const raw = ctx.messageContent || '';
    if (!raw)
        return '';
    return (0, messageUtils_1.buildAdMessage)(raw, ctx.messageType || 'LMS', !!ctx.isAd, ctx.opt080Number || '');
}
/**
 ...
 */
function buildAiGeneratedNotifyMessage(ctx) {
    const lines = [];
 ...
 */
function buildPreNotifyMessage(ctx) {
    const lines = [];
 ...
 */
function buildSpamTestResultNotifyMessage(ctx) {
    const lines = [];
...
//# sourceMappingURL=auto-notify-message.js.map