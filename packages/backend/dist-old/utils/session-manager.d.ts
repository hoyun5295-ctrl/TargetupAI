 ...
 */
export declare function invalidateAppSessions(userId: string, appSource: string): Promise<number>;
 ...
 */
export declare function createUserSession(params: CreateSessionParams): Promise<void>;
/**
 * 한 사용자의 로그인 처리 전체 흐름.
 ...
 */
export declare function rotateUserSession(params: CreateSessionParams): Promise<void>;
/**
 ...
 */
export declare function normalizeAppSource(raw: any): string;
