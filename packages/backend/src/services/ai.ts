...
### 3가지 variant별 차별화 (⚠️ 각 variant가 확실히 달라야 함!)
- **감성형(A)**: 따뜻한 인사로 시작, 고객과의 관계 강조, 정중하고 부드러운 톤, 브랜드 가치/철학 자연스럽게 녹이기
- **혜택강조형(B)**: 숫자와 혜택을 전면에, 구체적 조건 명시, ①②③ 구조화, 가격 비교(정보가 있을 때만), 실용적이고 직접적인 톤
- **MZ감성형(C)**: 캐주얼하고 친근한 말투, 짧은 문장, 호기심 유발 표현, 행동을 유도하는 가벼운 CTA ("지금 바로 득템!", "달려가세요!")
