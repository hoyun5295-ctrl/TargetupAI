...
// SDK 정본 — company-frontend/public/sdk/v0.3.8 (app.hanjul.ai/sdk). ?k= 로 공개 키 전달(v0.3.8+ fallback).
const SDK_SRC_BASE = 'https://app.hanjul.ai/sdk/v0.3.8/hanjul.min.js';
